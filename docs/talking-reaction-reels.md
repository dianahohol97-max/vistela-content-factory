# Рубрика «Talking reaction» — персонаж говорить, екран порожній

Відрізняється від решти паків: **звук УВІМКНЕНИЙ** (репліка — суть формату).

**Екран телефона порожній** — плоске темне скло. Продукт показуємо НАСТУПНИМ
кадром у чистому мокапі, а не на AI-екрані: так дизайн лишається ідеальним
(Veo «пливе» на дрібному тексті — імена, дата), а від AI беремо тільки емоцію
й репліку.
...
| Час | Кадр |
|---|---|
| 0–3 с | Персонаж реагує й каже репліку, телефон у руці, екран темний |
| 3–4 с | Вона дивиться на екран / повертає телефон — різ |
| 4–9 с | Продукт у рамці мокапа (наш композитинг), крупно |
| 9–12 с | Фінал: назва + link in bio |

## 5 правил, без яких ламається ліпсинк

1. **Одна коротка репліка, ≤ 8–10 слів.**
2. **Репліку окремим блоком:** `Audio: she says "..."`.
3. **`No subtitles, no captions, no on-screen text`** — Veo сам вписує субтитри.
4. **Голос:** `in a warm, casual American accent, conversational tone` — інакше
...
Персонаж-актор у рекламі — норма. Але фрази у формі відгуку («найкраща
покупка», «мої гості сказали…») від згенерованої людини читаються як фейковий
тестимоніал — лишаємось у межах реакції-відкриття.

- "Wait — this was ten dollars?"
- "And it plays our song."
- "This is our save the date."
- "I didn't expect it to actually move."
- "This cost less than my coffee."
- "One link and everything's on it." (сайт)
- "No printing, no postage."
- "I sent it in five minutes."

AI-лейбл на TikTok/Instagram обов'язковий — обличчя великим планом + синтетичний
голос.
...
> on the screen, exaggerated acting, advertising voice, blank stares, waxy
> plastic skin, airbrushed faces, perfect symmetry, morphing hands, extra
> fingers, slow motion, AI sheen.

## 3 · У кав'ярні, показує подрузі
...
Коли формат обкатається (ліпсинк тримає, обличчя виглядає живим) — можна буде
спробувати варіант із шаблоном як референсом, щоб дизайн був прямо на екрані.
Але поки базова версія — порожній екран + продукт наступним кадром.
